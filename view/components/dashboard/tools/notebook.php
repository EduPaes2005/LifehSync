        <div id="Notebook" class="tool-content">
            <div class="header">
                ...
                <button id="minimize-icon" onclick="showMinimizeAlert()"><hr></button>
            </div>
            ...
            <div class="body">
                ...
                <?php else: ?>
                    <p id="NotebooksCover">Nenhum caderno encontrado!
                        <br>
                        Caso ainda não tenha, clique em <b>"Criar"</b> e construa seus mais diversos espaços de anotações de maneira fácil e organizada.
                        <br>
                        Bom trabalho!
                    </p>
                <?php endif; ?>
        ...
        <div id="addNotebook" class="tool-content">
            ...
            <form id="form" action="?action=create" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="idUser" value="<?= $id_users ?>">
